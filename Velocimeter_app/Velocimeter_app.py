...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.espIPEdit.setText("192.168.4.1")
        self.espIPEdit.setFixedWidth(120)
        self.espIPEdit.setToolTip(
            "Fixed IP of the ESP32 Access Point (192.168.4.1).\n"
            "Connect your laptop to the 'OTT_ESPvelocimeter' WiFi network first."
        )
